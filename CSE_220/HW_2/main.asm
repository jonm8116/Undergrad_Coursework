...
decodedLength_input: .asciiz "" #original value: "sss!j4q!F5"
decodedLength_runFlag: .ascii "!"	  #original value: "!"
...
encodedLength_input: .asciiz "xxhhhhhhhhhhhhhhhuuunnnnnnnrere" #original value: "xxhhhhhhhhhhhhhhhuuunnnnnnnrere"
							#alternate value: AAAAAAAAAAAAAAAAAAAAAA

# encodeRun
encodeRun_header: .asciiz "\n\n********* encodeRun *********\n"
encodeRun_letter: .ascii "G"
.align 2
encodeRun_runLength: .word 43
